...
Please select from the menu (1-6): ");
    ...
    public void MenuActions(string input, EmailService _emailService, AccountManager accountManager, UserInterface accountUI)
    {
        ...
        // If #5: If the use wants to edit their account
        else if (input == "5")
        {
            // This is the edit account method
            AccountManager.EditAccount(accountManager, accountUI);

        } // End of if #5

        // If #6: if the user wants to quit the program
        else if (input == "6")
        {
...
");
    ...
    public void SetLoggedInAccount(AccountManager accountManager)
    {
        ...
        // This sets the logged in password
        _loggedInPassword = accountManager._loggedInPassword;
